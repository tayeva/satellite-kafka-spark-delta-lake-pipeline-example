...
class KafkaSparkClient(properties: Properties) {
    ...
    val kafkaTopics: Array[String] = properties.getProperty("kafkaTopics").split(",")
    ...
    val batchWindowSeconds: Int = properties.getProperty("batchWindowSeconds").toInt
    ...
    def getKafkaStream(context: StreamingContext): InputDStream[ConsumerRecord[String, Array[Byte]]] = {
